      ...
      >
        ...
        {status === 'success' ? (
          <div className="text-center py-4">
            ...
            <p className="body-text text-[15px] mb-2">You're on the list.</p>
            <p className="body-text text-[13px] text-[#9E9E9E]">
              We'll let you know as soon as the app is live.
            </p>
          </div>
        ) : (
          <>
            <div className="text-center mb-8">
              ...
              <p className="body-text text-[13px]">
                Leave your email and we'll let you know as soon as align is available.
              </p>
            </div>
